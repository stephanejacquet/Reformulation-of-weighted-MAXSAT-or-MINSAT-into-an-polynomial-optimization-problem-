...
//  Purpose:
//
//    MAIN is the main program for latin_center.cpp.
//
...
//	cout<<"You should give an argument\n";
 ...
 // cout<<"the file name is "<< cnf_file_name<< endl;
  ...
  int num_points=5;
  int seed=10;
  double lh[num_points*dim_num];
  cout << "\n \n";
  cout << "Pourvu que ca marche...\n";

  latin_center (dim_num, num_points, &seed,lh);
  cout << "Ecris les moi! Et que ca saute!\n";
  ...
  for(int i=0;i<num_points;i++)
{
	...
	cout <<  lh[i+num_points*j]<< " ";
	
     
	}	
cout << endl;
}
  cout << "Ca marche pour de vrai!\n";



ofstream myfile0;
myfile0.open ("simple.pin");
